...
\rhead{In-Class Activity: 2SLS in Action}
...
\item Using the simple IV formula below,explain intuitively why the IV estimate is larger than the OLS estimate.

\[
\hat{\beta}_1^{IV} = \frac{\text{Cov}(\text{log wage},\, \text{Born Q1})}{\text{Cov}(\text{educ},\, \text{Born Q1})},
\]
...
\item Name one threat to the validity of quarter of birth as an instrument for education. That is, give a reason why the exogeneity or exclusion restriction might fail.
