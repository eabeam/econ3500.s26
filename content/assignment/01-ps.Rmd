...
Welcome to Problem Set 1! There are two "problem" exercises and one extended Stata exercise. You'll need to submit two things on Brightspace: a problem set and log file. If you have trouble with the Stata basics, head back to [Lab 1](../01-lab/).

> *Tip: If, after doing these problems you still want more practice, the odd-numbered problems in Chapters 2 and 3 of Stock and Watson are quite useful, and solutions are available online.*

::: {.callout .callout-note}
**Note.** This is a call-out box. You can put *Markdown* in here.
:::
...
3.  Download [`countymurders.dta`](../countymurders.dta) to answer this question.[^5] The variable
