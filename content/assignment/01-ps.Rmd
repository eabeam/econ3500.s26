...
Welcome to Problem Set 1! There are two "problem" exercises and one extended Stata exercise. You'll need to submit three things on Brightspace: a problem set, log file, *and* a do-file. 
