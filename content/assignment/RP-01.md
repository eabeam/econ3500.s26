...
-   It must use *cross-sectional* or *`panel* data. There are lots of interesting time-series questions, but we will not cover these  topics in ECON350. I highly, highly recommend that work with data from  [IPUMS](https://www.ipums.org/). I am open to other **large** data sets ($n>100$, ideally $n>1000$), but these require prior approval.
...
Now is a good time to refer to our class [Gen AI policy](../../syllabus/#gen-ai-policy)! *TLDR; ChatGPT can be your friend, but no more.*

## Research paper process {#research-paper-process .unnumbered}

### [Research ideas](../rp-02-ideas) {#research-ideas .unnumbered}

Prepare a set of 3 research ideas. An "idea" only needs to consist of about 2-3 paragraphs, which should include a research question, a hypothesis, a
...
From the list of topics, choose and develop one research idea for your [research proposal](../rp-04-proposal). You'll write up research proposal of at least 1200 words. This proposal should provide as much detail as possible to help me and your classmates assess your plan and provide useful feedback.
...
You'll make a brief (6-8 minute) [presentation](../rp-07-presentation) of your paper in the
final week of class. I will provide specifics later.

### Final submission 

Your [final draft](../rp-08-final-submission) will be due on May 04. Please make sure to review all the [requirements](#paper-components) carefully!
...
### Replication package {#replication .unnumbered} 
...
1. Stata do-file that replicates your analysis
     a. This should be "push-button." That is, I should be able to load it, adjust the main file path, and run it once to replicate all your results. 
     b. The do-file should therefore declare one a file path at beginning of file rather than using local paths throughout
2. Raw data file.
3. Log file that shows your results fron running your do-file
4. If anything might seem confusing to me, include a Readme file to tell me what to do!
...
- If the file is too large, use [UVM File Transfer](https://filetransfer.uvm.edu/)
...
you have a clear idea of how you'll be graded. As the [syllabus](../../syllabus#grading) shows, your total research paper score will account for 35% of your final grade. 
...
-   *How should I format my citations and bibliography?* Consistently.
    APA or Chicago is fine. MLA is not. 
