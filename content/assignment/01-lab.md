...
Stata looks for data files in its *working directory*. To see your current
working directory, type:

`pwd`

If your data file is not located there, Stata will not find it. You can
...
3.  Type `use filename.dta, clear` into the command window within Stata. The option `, clear` tells Stata to remove any data currently in memory.
Stata can only hold one dataset at a time.[^3]

[^3]: Yes, this is a pain.


Download [`driving_2004.dta`](../materials/driving_2004.dta) and open it. I recommend moving it to your brand new class folder first. It is a
...
[Lab 1 Overview](https://youtu.be/uze1JNmFTq8)
