...
2. Read the box *"The Return to Education and the Gender Gap"* in Section 8.3 of your textbook (Stock & Watson).
...
5. This question uses directed acyclic graphs (DAGs), which we will cover in class. You may also find it helpful to read Huntington-Klein, *The Effect*, [Chapter 8: Causal Paths and Closing Back Doors](https://theeffectbook.net/ch-CausalPaths.html), especially Sections 8.3–8.5.
...
7. Revisit the box *"The Return to Education and the Gender Gap"* in Section 8.3 of your textbook (Stock & Watson). Discuss the internal and external validity of the estimated effect of education on earnings.



8. Use the dataset [`CollegeDistance.dta`](https://www.princeton.edu/~mwatson/Stock-Watson_3u/Students/EE_Datasets/CollegeDistance.dta) (described in Empirical Exercise AEE 4.3) to answer the following questions.
