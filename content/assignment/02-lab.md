...
### What do I submit?
   ...
   -  Your written-up answers to exercise questions (1) - (12). This can be typed or written out, then scanned (or photographed). If scanning, please upload as a `.pdf`, not a `.jpg` or `.png`! 
...
11. Make two histograms, one of the income distrition for men and one of the income distribution for women. Make sure the y-axis indicates the "fraction" of individuals, not the density. Copy and paste it into your responses. If you 
