...
## Motivating Example: Minimum Wage Increases {.smaller}

**Research question:** Do minimum wage increases reduce employment in low-wage industries?

. . .

Different states raise their minimum wages in [different years]{.kw}:

| State | Change | Year |
|---|---|:---:|
| Washington | $8.55 → $9.47 | 2014 |
| California | $9.00 → $10.00 | 2016 |
| New York | $9.00 → $11.10 | 2017 |

. . .

**Natural approach:** Two-way FE regression:
$$emp_{it} = \beta_1 \cdot minwage_{it} + \alpha_i + \lambda_t + u_{it}$$

When treatment effects are [homogeneous]{.kw} across states and stable over time, TWFE gives the right answer. But what if Washington's employment responds differently than California's — or if effects grow over time?
