...
![](./ch5_figures/ch5_rejection_regions.png){width=65% height=auto}
...
![](./ch5_figures/ch5_one_vs_two_tailed.png){width=95%}
...
1. ::: {.fragment}
   $t = \dfrac{3.5 - 0}{1.2} = 2.92$
   :::
2. ::: {.fragment}
   Critical value: $c_{\alpha/2} = 1.96$
   :::
3. ::: {.fragment}
   Since $|2.92| > 1.96$, **reject $H_0$** at 5% level.
   :::
   ::: {.fragment}
...
![](./ch5_figures/ch5_power_curve.png){width=75%}
...
![](./ch5_figures/ch5_pvalue.png){width=85%}
...
![](./ch5_figures/ch5_multiple_ci_levels.png){width=75%}
...
![](./ch5_figures/ch5_sample_size_ci.png){width=75%}
...
![](./ch5_figures/ch5_se_comparison.png){width=60%}
