...
$$\underbrace{(70{,}619 - 63{,}693)}_{\Delta \text{ treatment}} - \underbrace{(101{,}308 - 82{,}517)}_{\Delta \text{ control}} = [-11{,}864]{.alert}$$
:::
:::
...
Event study plots have become nearly [mandatory]{.alert} in applied DiD papers. They are the most credible way to support the parallel trends assumption.
:::
