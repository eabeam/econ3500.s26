...
## BJB (1995) Problem 1: Inconsistency When the First Stage is Weak {.smaller}
...
Plus other QOB correlates (school attendance, behavioral problems, reading/writing/math, IQ, schizophrenia) --- any could open a direct $Z \to Y$ channel.

## BJB (1995) Problem 2: Finite-Sample Bias {.smaller}
