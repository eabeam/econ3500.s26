...
source_md = root / "content" / "assignment" / "03-lab.md"
temp_md = root / "content" / "assignment" / "03-lab-pandoc.md"
output_pdf = root / "content" / "assignment" / "03-lab.pdf"
...
text = text.replace("**[Print-friendly pdf](../03-lab.pdf)**\n", "")
...
text = text.replace("{{% alert note %}}", "")
text = text.replace("{{% alert warning %}}", "")
...
\\LARGE\\textbf{ECON3500 Lab 3: Regression}
\\end{center}
